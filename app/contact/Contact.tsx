...
const Contact = () => {
  ...
  return (
    <section className="mt-16 md:mt-20 md:mb-10">
      <div className="flex justify-center items-center">
        <h1
          className={`${dmSerifFont.className} text-[#292F36] text-center text-[1.25rem] md:text-[1.5rem] min-w-[21.875rem] sm:max-w-full lg:text-[2.5rem]`}
        >
          We love meeting new people and helping them.
        </h1>
      </div>
      <article
        className={`mt-10 md:mt-16 flex flex-col sm:flex-row sm:justify-between 2xl:justify-center sm:space-x-10 lg:space-x-14 xl:space-x-20 space-y-16 sm:space-y-0 ${jostFont.className}`}
      >
        <aside className={`text-[#4D5053] space-y-2`}>
          {/* email */}
        ...
        <form onSubmit={handleSubmit} className="w-full space-y-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-10">
            <input
              ...
              id="name"
              aria-label="Name"
              className="border-[#000000] border-b md:text-[1.125rem] pb-1 lg:text-[1.25rem] text-[#4D5053] placeholder:text-[#4D5053] sm:max-w-[23.625rem] 2xl:w-[23.625rem] focus:outline-none"
            />
            <input
              type="email"
              placeholder="Email"
          ...
          <div>
            <textarea
              ...
              id="message"
              aria-label="message"
              className="border-[#000000] border-b lg:text-[1.25rem] text-[#4D5053] placeholder:text-[#4D5053] w-full h-[9.375rem] focus:outline-none"
      ...
      <div className="relative w-full max-w-[1191px] h-full max-h-[501px]">
        <Image
          src="/images/map.png"
          alt="selhono-map"
          fill
